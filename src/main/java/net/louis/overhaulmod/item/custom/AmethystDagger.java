...
public class AmethystDagger extends PickaxeItem {
    ...
    private static final Set<Item> REDSTONES = Set.of(
            Items.REPEATER,
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        else if (REDSTONES.contains(offHand.getItem())) {
            user.getInventory().offerOrDrop(new ItemStack(Items.REDSTONE, 1));
            world.playSound(null, user.getX(), user.getY(), user.getZ(),
        ...
        else if (offhandBlock.equals(Blocks.AMETHYST_BLOCK)) {
            user.getInventory().offerOrDrop(new ItemStack(Blocks.AMETHYST_CLUSTER, 1));
            world.playSound(null, user.getX(), user.getY(), user.getZ(),
