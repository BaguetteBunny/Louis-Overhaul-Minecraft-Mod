...
public record SmeltingEnchantmentEffect() implements EnchantmentEntityEffect {
    ...
    static {
        ...
        TRANSFORM_MAP.put(Blocks.RAW_IRON_BLOCK, Items.IRON_INGOT);
        TRANSFORM_MAP.put(Blocks.RAW_GOLD_BLOCK, Items.GOLD_INGOT);
        TRANSFORM_MAP.put(Blocks.RAW_COPPER_BLOCK, Items.COPPER_INGOT);
        ...
        TRANSFORM_MAP.put(Blocks.SPONGE, Items.WET_SPONGE);
