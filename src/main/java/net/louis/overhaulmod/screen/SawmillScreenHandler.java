...
public class SawmillScreenHandler extends ScreenHandler {
    ...
    private List<RecipeEntry<SawmillRecipe>> availableRecipes = Lists.<RecipeEntry<SawmillRecipe>>newArrayList();
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(ModRecipes.SAWMILL_TYPE, createRecipeInput(input), this.world);
        }
    }

    void populateResult() {
        if (!this.availableRecipes.isEmpty() && this.isInBounds(this.selectedRecipe.get())) {
            RecipeEntry<SawmillRecipe> recipeEntry = (RecipeEntry<SawmillRecipe>)this.availableRecipes.get(this.selectedRecipe.get());
    ...
    public ItemStack quickMove(PlayerEntity player, int slot) {
        ...
        if (slot2 != null && slot2.hasStack()) {
            ...
            } else if (this.world.getRecipeManager().getFirstMatch(ModRecipes.SAWMILL_TYPE, new SingleStackRecipeInput(itemStack2), this.world).isPresent()) {
